...
namespace OnPoint.WpfCore
{
    public class MahIconDetails<TIcon, TForeground> : IconDetails where TForeground : class
    {
        ...
        public MahIconDetails(TIcon icon, TForeground foreground = null, double width = 16, double height = 16, GridPosition gridPosition = GridPosition.Fill)
    ...
    public class BootstrapIconsIconDetails : MahIconDetails<PackIconBootstrapIconsKind, SolidColorBrush>
    {
        ...
        public BootstrapIconsIconDetails(PackIconBootstrapIconsKind icon, SolidColorBrush solidColorBrush, double width, double height) : base(icon, solidColorBrush, width, height) { }
    }
    ...
    public class BoxIconsIconDetails : MahIconDetails<PackIconBoxIconsKind, SolidColorBrush>
    {
        ...
        public BoxIconsIconDetails(PackIconBoxIconsKind icon, SolidColorBrush solidColorBrush, double width, double height) : base(icon, solidColorBrush, width, height) { }
    }
    ...
    public class PackIconEntypoDetails : MahIconDetails<PackIconEntypoKind, SolidColorBrush>
    {
        ...
        public PackIconEntypoDetails(PackIconEntypoKind icon, SolidColorBrush solidColorBrush, double width, double height) : base(icon, solidColorBrush, width, height) { }
    }
    ...
    public class EvaIconDetails : MahIconDetails<PackIconEvaIconsKind, SolidColorBrush>
    {
        ...
        public EvaIconDetails(PackIconEvaIconsKind icon, SolidColorBrush solidColorBrush, double width, double height) : base(icon, solidColorBrush, width, height) { }
    }
    ...
    public class FeatherIconDetails : MahIconDetails<PackIconFeatherIconsKind, SolidColorBrush>
    {
        ...
        public FeatherIconDetails(PackIconFeatherIconsKind icon, SolidColorBrush solidColorBrush, double width, double height) : base(icon, solidColorBrush, width, height) { }
    }
    ...
    public class FontAwesomeIconDetails : MahIconDetails<PackIconFontAwesomeKind, SolidColorBrush>
    {
        ...
        public FontAwesomeIconDetails(PackIconFontAwesomeKind icon, SolidColorBrush solidColorBrush, double width, double height) : base(icon, solidColorBrush, width, height) { }
    }
    ...
    public class IonIconDetails : MahIconDetails<PackIconIoniconsKind, SolidColorBrush>
    {
        ...
        public IonIconDetails(PackIconIoniconsKind icon, SolidColorBrush solidColorBrush, double width, double height) : base(icon, solidColorBrush, width, height) { }
    }
    ...
    public class JamIconDetails : MahIconDetails<PackIconJamIconsKind, SolidColorBrush>
    {
        ...
        public JamIconDetails(PackIconJamIconsKind icon, SolidColorBrush solidColorBrush, double width, double height) : base(icon, solidColorBrush, width, height) { }
    }
    ...
    public class MaterialIconDetails : MahIconDetails<PackIconMaterialKind, SolidColorBrush>
    {
        ...
        public MaterialIconDetails(PackIconMaterialKind icon, SolidColorBrush solidColorBrush, double width, double height) : base(icon, solidColorBrush, width, height) { }
    }
    ...
    public class MaterialDesignIconDetails : MahIconDetails<PackIconMaterialDesignKind, SolidColorBrush>
    {
        ...
        public MaterialDesignIconDetails(PackIconMaterialDesignKind icon, SolidColorBrush solidColorBrush, double width, double height) : base(icon, solidColorBrush, width, height) { }
    }
    ...
    public class MaterialLightIconDetails : MahIconDetails<PackIconMaterialLightKind, SolidColorBrush>
    {
        ...
        public MaterialLightIconDetails(PackIconMaterialLightKind icon, SolidColorBrush solidColorBrush, double width, double height) : base(icon, solidColorBrush, width, height) { }
    }
    ...
    public class MicronsIconDetails : MahIconDetails<PackIconMicronsKind, SolidColorBrush>
    {
        ...
        public MicronsIconDetails(PackIconMicronsKind icon, SolidColorBrush solidColorBrush, double width, double height) : base(icon, solidColorBrush, width, height) { }
    }
    ...
    public class ModernIconDetails : MahIconDetails<PackIconModernKind, SolidColorBrush>
    {
        ...
        public ModernIconDetails(PackIconModernKind icon, SolidColorBrush solidColorBrush, double width, double height) : base(icon, solidColorBrush, width, height) { }
    }
    ...
    public class OcticonsIconDetails : MahIconDetails<PackIconOcticonsKind, SolidColorBrush>
    {
        ...
        public OcticonsIconDetails(PackIconOcticonsKind icon, SolidColorBrush solidColorBrush, double width, double height) : base(icon, solidColorBrush, width, height) { }
    }
    ...
    public class PicolIconDetails : MahIconDetails<PackIconPicolIconsKind, SolidColorBrush>
    {
        ...
        public PicolIconDetails(PackIconPicolIconsKind icon, SolidColorBrush solidColorBrush, double width, double height) : base(icon, solidColorBrush, width, height) { }
    }
    ...
    public class RPGAwesomeIconDetails : MahIconDetails<PackIconRPGAwesomeKind, SolidColorBrush>
    {
        ...
        public RPGAwesomeIconDetails(PackIconRPGAwesomeKind icon, SolidColorBrush solidColorBrush, double width, double height) : base(icon, solidColorBrush, width, height) { }
    }
    ...
    public class SimpleIconDetails : MahIconDetails<PackIconSimpleIconsKind, SolidColorBrush>
    {
        ...
        public SimpleIconDetails(PackIconSimpleIconsKind icon, SolidColorBrush solidColorBrush, double width, double height) : base(icon, solidColorBrush, width, height) { }
    }
    ...
    public class TypIconDetails : MahIconDetails<PackIconTypiconsKind, SolidColorBrush>
    {
        ...
        public TypIconDetails(PackIconTypiconsKind icon, SolidColorBrush solidColorBrush, double width, double height) : base(icon, solidColorBrush, width, height) { }
    }
    ...
    public class UniIconDetails : MahIconDetails<PackIconUniconsKind, SolidColorBrush>
    {
        ...
        public UniIconDetails(PackIconUniconsKind icon, SolidColorBrush solidColorBrush, double width, double height) : base(icon, solidColorBrush, width, height) { }
    }
    ...
    public class WeatherIconDetails : MahIconDetails<PackIconWeatherIconsKind, SolidColorBrush>
    {
        ...
        public WeatherIconDetails(PackIconWeatherIconsKind icon, SolidColorBrush solidColorBrush, double width, double height) : base(icon, solidColorBrush, width, height) { }
    }
    ...
    public class ZondIconDetails : MahIconDetails<PackIconZondiconsKind, SolidColorBrush>
    {
        ...
        public ZondIconDetails(PackIconZondiconsKind icon, SolidColorBrush solidColorBrush, double width, double height) : base(icon, solidColorBrush, width, height) { }
    }
}